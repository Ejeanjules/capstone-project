...
# ✅ Email settings
# Use console backend for development, SMTP/API for production
if DEBUG:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'noreply@yourapp.com'
else:
    # Production email settings
    # Check if using Anymail (Mailgun API) or traditional SMTP
    USE_ANYMAIL = config('USE_ANYMAIL', default=False, cast=bool)
    
    if USE_ANYMAIL:
        # Mailgun API (more reliable than SMTP)
        ...
        # Traditional SMTP (works with SendGrid, Gmail, etc.)
        ...
        EMAIL_TIMEOUT = 30  # Increased timeout for potentially slow connections
        
        # Additional SMTP configuration for better reliability
